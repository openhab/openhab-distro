    ...
    if "%IS_RUNNABLE%" == "true" (
        ...
        if %JAVA_VERSION% GTR 8 (
            "%JAVA%" %JAVA_OPTS% %OPTS% ^
                ...
                --patch-module java.base="%KARAF_HOME%\lib\endorsed\org.apache.karaf.specs.locator-4.4.8-SNAPSHOT.jar" ^
                --patch-module java.xml="%KARAF_HOME%\lib\endorsed\org.apache.karaf.specs.java.xml-4.4.8-SNAPSHOT.jar" ^
